...
export class GoogleMapsService {
  ...
  getDirectionsWaypoints(origin: google.maps.LatLng, destination: google.maps.LatLng, waypnts: google.maps.DirectionsWaypoint[]) : Observable<google.maps.DirectionsResult> {
    let _origin: google.maps.Place = {
          location: origin
        },
        _destination: google.maps.Place = {
  ...
  getDistanceMatrixWaypoints(origin: google.maps.LatLng, destination: google.maps.LatLng, waypnts: google.maps.LatLng[]) : Observable<google.maps.DistanceMatrixResponse> {
    let _origins: google.maps.Place[], 
        _destinations: google.maps.Place[],
        _waypnt: google.maps.Place;
    ...
    for(var i=0;i<waypnts.length;i++){
      _waypnt={location: waypnts[i]};
      _origins.push(_waypnt);
      _destinations.push(_waypnt);
    }
    ...
    let distance_query: google.maps.DistanceMatrixRequest = {
          origins: _origins,
